...
var __foMain = function () {
  ...
  var MyMap = function (_Map) {
    function MyMap() {
      return _Map.apply(this, arguments) || this;
    }
    _inherits(MyMap, _Map);
    var _proto = MyMap.prototype;
    _proto.double = function double(key) {
      var _this$get;
      return ((_this$get = this.get(key)) != null ? _this$get : 0) * 2;
    };
    return _createClass(MyMap);
  ...
  var Derived = function (_Base) {
    ...
    var _proto3 = _Derived.prototype;
    _proto3.describe = function describe() {
  ...
  function probe() {
    ...
    record(out, "subclass-map", function () {
      var m = new MyMap();
      m.set("a", 2);
      return m instanceof MyMap && m instanceof Map && m.double("a") === 4;
    });
    record(out, "subclass-error", function () {
